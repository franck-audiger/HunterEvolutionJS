...
Scene_Battle.prototype.startActorCommandSelection = function() {
    this._statusWindow.select(BattleManager.getCurrentInputActor().index());
    this._actorCommandWindow.setup(BattleManager.getCurrentInputActor());
};

Scene_Battle.prototype.commandAttack = function() {
    BattleManager.getCurrentInputActor().inputtingAction().setAttack();
    this.selectEnemySelection();
};

Scene_Battle.prototype.commandSkill = function() {
    this._skillWindow.setActor(BattleManager.getCurrentInputActor());
...
Scene_Battle.prototype.onActorOk = function() {
    var actor = BattleManager.getCurrentInputActor();
...
Scene_Battle.prototype.selectEnemySelection = function() {
    ...
    this._enemyWindow._action = BattleManager.getCurrentInputActor().inputtingAction();
};
...
Scene_Battle.prototype.onSkillOk = function() {
    ...
    BattleManager.getCurrentInputActor().setLastBattleSkill(skill);
    this.onSelectAction();
};
